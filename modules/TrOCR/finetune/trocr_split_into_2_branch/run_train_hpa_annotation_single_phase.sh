...
#   /home/ubuntu/dataset/train/annotation/*.jpg
#
...
#   HF_TOKEN=hf_xxx ./run_train_hpa_annotation_single_phase.sh
#
# Or with env file:
#   ENV_FILE=/home/ubuntu/.env.hpa ./run_train_hpa_annotation_single_phase.sh
#
# Example .env.hpa:
#   HF_TOKEN=hf_xxx
...
VENV_DIR="${VENV_DIR:-$SCRIPT_DIR/.venv_hpa_annotation}"
...
REQ_STAMP="$VENV_DIR/.requirements_hpa_annotation_installed"
...
export HPA_OUTPUT_DIR="${HPA_OUTPUT_DIR:-/home/ubuntu/outputs_hpa_annotation_single}"
export HPA_FINAL_DIR="${HPA_FINAL_DIR:-$HPA_OUTPUT_DIR/final_trocr_base_annotation_model}"
...
export HPA_EVAL_BATCH_SIZE="${HPA_EVAL_BATCH_SIZE:-32}"
...
export HPA_MAX_TARGET_LENGTH="${HPA_MAX_TARGET_LENGTH:-64}"
export HPA_GEN_EVAL_BATCH_SIZE="${HPA_GEN_EVAL_BATCH_SIZE:-${HPA_GENERATION_EVAL_BATCH_SIZE:-16}}"

TRAIN_SCRIPT="$SCRIPT_DIR/train_hpa_annotation_single_phase.py"
