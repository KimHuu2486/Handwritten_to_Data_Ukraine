...
def run_inference_single_image(model, processor, img_path, device):
    ...
    few_shots = [
        {
            "img": "/kaggle/input/datasets/quii29/rukopys-dataset/train/images/09d923a3-1043-42b3-ba38-fa74540307cc.jpg",
            "json": """[
  {"bbox": [14, 169, 994, 996], "type": "table", "text": "№№ п/п | Учрежд. | Полагается | Выдан | Остает | Примечание\\n1 | Фав. К-сія | молоко. 40 | мыло 85 | масл. 17 | 40 | 85 | 17 | | \\n2 | Лит.клуб.. | 40 | 85 | 16 | 40 | 85 | 16 | - | - | - \\n3 | Площадки | 31 1/2 | 40 | | 31 1/2 | 40 | ) 46 1/2\\n4 | Почаевской, 23 | 47/4г- 4 2/1 | 350 | | 47 1/2 - 4 2/1 | 350 | ) 110 kg\\n5 | Дмитр.. Лит.Пункт. | 20 1/2 - 3 1/2 | 100 | | 20 1/2 - 3 1/2 | 100 | - | | | ) 60 ф\\n6 | Шилянск. 46 | 20 1/2 - 3 4/1 | 140 | | 20 1/2 - 3 1/2 | 140 | ) 64 ф\\n7 | Демиевка | 20 1/2 - 15/1 | 75 | | 20 1/2 - 15/1 | 75 | ) 45 ф.\\n8 | Соломенка | 20 1/2 - 15/1 | 75 | | 20 1/2 - 15/1 | 75 | ) 45 ф"},
  {"bbox": [72, 13, 246, 36], "type": "handwritten", "text": "молока 499"},
  {"bbox": [126, 30, 247, 51], "type": "formula", "text": "+   22"},
  {"bbox": [66, 48, 267, 70], "type": "handwritten", "text": "мило 1.059k."},
  {"bbox": [66, 70, 254, 91], "type": "handwritten", "text": "масло 215 ф"},
  {"bbox": [315, 20, 699, 61], "type": "handwritten", "text": "Вѣдимости"},
  {"bbox": [443, 62, 538, 85], "type": "handwritten", "text": "нa"},
  {"bbox": [172, 88, 957, 125], "type": "handwritten", "text": "продукти для пит. - пунк."},
  {"bbox": [157, 121, 760, 167], "type": "handwritten", "text": "п общепитт Ц.К."},
  {"bbox": [879, 25, 947, 66], "type": "annotation", "text": "42"}
]"""
        }
    ]
...
def worker_process(gpu_id, image_filenames, output_csv):
    ...
    # Ép toàn bộ model load vào riêng GPU này, sử dụng SDPA (Giải pháp 3)
